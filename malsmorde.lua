...
function IsInvulnerable(target)
        if target ~= nil and target.dead == 0 then
                if target.invulnerable == 1 then
                    ChampList[target.charName]={status = 1, name = nil, amount = nil, type = nil}
                    return {status = 1, name = nil, amount = nil, type = nil}
                else
                    StatusReturn=nil
                                        run_every(0.3,getStatus,target)
                    if StatusReturn~=nil then
                        ChampList[target.charName]=StatusReturn
                        return  StatusReturn
                    end
                end
                                if ChampList[target.charName] then
                                        return ChampList[target.charName]
                                else
                                        ChampList[target.charName]={status = 0, name = nil, amount = nil, type = nil}
...
function getStatus(target)
        for i=1, objManager:GetMaxObjects(), 1 do
                        ...
                        if object ~= nil then
                                        if string.find(object.charName,"eyeforaneye") ~= nil and GetDistance(target,object) <= 20 then
                                                StatusReturn = {status = 1, name = 'Intervention', amount = 0, type = 'ALL'}
                                                return
                                        elseif string.find(object.charName,"nickoftime") ~= nil and GetDistance(target,object) <= 20 then
                                                StatusReturn = {status = 4, name = 'Chrono Shift', amount = 0, type = 'REVIVE'}
                                                return
                                        elseif target.name == 'Poppy' and string.find(object.charName,"DiplomaticImmunity_tar") ~= nil and GetDistance(myHero,object) > 20 then
                                                        for i=1, objManager:GetMaxObjects(), 1 do
                                                                        ...
                                                                        if diObject ~= nil and string.find(diObject.charName,"DiplomaticImmunity_buf") ~= nil and GetDistance(target,diObject) <= 20 then
                                                                                StatusReturn = {status = 1, name = 'Diplomatic Immunity', amount = 0, type = 'ALL'} end
                                                                return
                                                        end
                                        elseif target.name == 'Vladimir' and string.find(object.charName,"VladSanguinePool_buf") ~= nil and GetDistance(myHero,object) <= 20 then
                                                StatusReturn = {status = 1, name = 'Sanguine Pool', amount = 0, type = 'ALL'}
                                                return
                                        ...
                                        elseif (string.find(object.charName,"Global_Spellimmunity") ~= nil or string.find(object.charName,"Morgana_Blackthorn_Blackshield") ~= nil) and GetDistance(target,object) <= 20 then
                                                        ...
                                                        for i= 1,objManager:GetMaxHeroes(),1 do
                                                                        ...
                                                                        if hero.team == target.team and hero.name == 'Morgana' then
                                                                                        ...
                                                                                        StatusReturn = {status = 2, name = 'Black Shield', amount = amount, type = 'MAGIC'}
                                                                                return
                                                                        end
                                                        end
                                        elseif string.find(object.charName,"bansheesveil_buf") ~= nil and GetDistance(target,object) <= 20 then
                                                StatusReturn = {status = 2, name = 'Banshees Veil', amount = 0, type = 'SPELL'}
                                                return
                                        elseif target.name == 'Sivir' and string.find(object.charName,"Sivir_Base_E_shield") ~= nil and GetDistance(target,object) <= 20 then
                                                StatusReturn = {status = 2, name = 'Spell Shield', amount = 0, type = 'SPELL'}
                                                return
                                        elseif target.name == 'Nocturne' and string.find(object.charName,"nocturne_shroudofDarkness_shield") ~= nil and GetDistance(target,object) <= 20 then
                                                StatusReturn = {status = 2, name = 'Shroud of Darkness', amount = 0, type = 'SPELL'}
                                                return
                                        elseif target.name == 'Tryndamere' and string.find(object.charName,"UndyingRage_buf") ~= nil and GetDistance(target,object) <= 20 then
                                                StatusReturn = {status = 4, name = 'Undying Rage', amount = 0, type = 'NONE'}
                                                return
                                        elseif string.find(object.charName,"rebirthready") ~= nil and GetDistance(target,object) <= 20 then
                                                StatusReturn = {status = 3, name = 'Guardian Angel', amount = 0, type = 'REVIVE'}
                                                return
                                        elseif target.name == 'Anivia' then
                                                        if target.team == myHero.team then
                                                                        if GetTickCount()-egg.allied.time > 240000 or egg.allied.time == 0 then
                                                                                StatusReturn = {status = 3, name = 'Egg', amount = 0, type = 'REVIVE'}
                                                                                return
                                                                        else
                                                                                StatusReturn = {status = 0, name = nil, amount = nil, type = nil} end
                                                                                return
                                                        else
                                                                        if GetTickCount()-egg.enemy.time > 240000 or egg.enemy.time == 0 then
                                                                                StatusReturn = {status = 3, name = 'Egg', amount = 0, type = 'REVIVE'}
                                                                                return
                                                                        else
                                                                                StatusReturn = {status = 0, name = nil, amount = nil, type = nil} end
                                        ...
                                        elseif target.name == 'Aatrox' then
                                                        if target.team == myHero.team then
                                                                        if GetTickCount()-aatrox.allied.time > 225000 or aatrox.allied.time == 0 then
                                                                                StatusReturn = {status = 3, name = 'Aatrox', amount = 0, type = 'REVIVE'}
                                                                                return
                                                                        else
                                                                                StatusReturn = {status = 0, name = nil, amount = nil, type = nil}
                                                                                return
                                                                        end
                                                        elseif target.team ~= myHero.team then
                                                                        if GetTickCount()-aatrox.enemy.time > 225000 or aatrox.enemy.time == 0 then
                                                                                StatusReturn = {status = 3, name = 'Aatrox', amount = 0, type = 'REVIVE'}
                                                                                return
                                                                        else
                                                                                StatusReturn = {status = 0, name = nil, amount = nil, type = nil}
                                        ...
                                        elseif target.name == 'Zac' then
                                                        if target.team == myHero.team then
                                                                        if GetTickCount()-zac.allied.time > 300000 or zac.allied.time == 0 then
                                                                                StatusReturn = {status = 3, name = 'Zac', amount = 0, type = 'REVIVE'}
                                                                                return
                                                                        else
                                                                                StatusReturn = {status = 0, name = nil, amount = nil, type = nil}
                                                                                return
                                                        ...
                                                        elseif target.team ~= myHero.team then
                                                                        if GetTickCount()-zac.enemy > 300000 or zac.enemy.time == 0 then
                                                                                StatusReturn = {status = 3, name = 'Zac', amount = 0, type = 'REVIVE'}
                                                                                return
                                                                        else
                                                                                StatusReturn = {status = 0, name = nil, amount = nil, type = nil}
