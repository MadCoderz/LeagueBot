...
if GetSelf().name == "Ryze" then
        ...
        maxRange = 625                   -- only cast the combo if the target is in this range, set it to nil to use the spells ranges defnited in the table below
        ...
        spellInfo = {
            ...
            Q = { spellName = "Q", castType = "Target", range = 625, dmgType = 'magic', mode = "EnemyCast",    condition = "None", value = "None" },
